	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_cast_1 = (( temp_output_127_0 * ( ( 0.0 * IN.ase_texcoord8.w ) * _EmissiveMult ) )).xxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float distanceDepth121 = saturate( ( screenDepth121 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( smoothstepResult123 ) );
				float temp_output_127_0 = saturate( ( saturate( tex2DNode83.a ) * distanceDepth121 ) );
				float3 temp_cast_1 = (( temp_output_127_0 * ( ( 0.0 * IN.ase_texcoord4.w ) * _EmissiveMult ) )).xxx;
...
Node;AmplifyShaderEditor.TFHCFlipBookUVAnimation;82;-2560,256;Inherit;False;0;0;7;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;-1;False;4;FLOAT2;0;FLOAT;1;FLOAT;2;INT;3
Node;AmplifyShaderEditor.TexturePropertyNode;72;-2560,-256;Inherit;True;Property;_Flipbook;Flipbook;5;0;Create;True;0;0;0;False;3;Space(33);Header(Flipbook);Space(13);False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;118;-896,1152;Inherit;False;Property;_EmissiveTint;Emissive Tint;12;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;114;-256,1152;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;-256,1024;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;130;-256,768;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=ED672DFDA29B04B104912A5E977D69DB013BB0DE